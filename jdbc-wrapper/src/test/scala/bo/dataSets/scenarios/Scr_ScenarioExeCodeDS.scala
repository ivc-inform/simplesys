...
case class Scr_ScenarioExeCodeDSData(exeCodeScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) {

}


 
object Scr_ScenarioExeCodeDS {
     def apply(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioExeCodeDS(alias = SQLAlias(strEmpty))    
     def apply(alias: SQLAlias)(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioExeCodeDS    
...
class Scr_ScenarioExeCodeDS(override val alias: SQLAlias)(implicit val dataSource: BoneCPDataSource) extends DataSet[Scr_ScenarioExeCodeDS]  {
     def this()(implicit dataSource: BoneCPDataSource) = this(SQLAlias(strEmpty))(dataSource)    
    
    val quoted = true    
    
     def init[FT <: Product with FieldProduct](columns: FT = null, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null): Scr_ScenarioExeCodeDS = {
        _columns = columns
        _join Join join
        _where Where where
...
///////////////////////////////////////// Class: Scr_ScenarioBo, group: scenarios /////////////////////////////////////////    
    ...
    val Scr_Scenario = new Scr_ScenarioBoExeCode(alias = alias + "B0".als)    
...
//////////////////////////////////////////////// End Fetch ////////////////////////////////////////////////    
    ...
    val exeCodeScr_Scenario = Scr_Scenario.exeCode    
...
//////////////////////////////////////// End Class: Scr_ScenarioBo, group: scenarios ////////////////////////////////////////    
    ...
    // For select tuple: (exeCodeScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long)    
    
    type ColumnTypes =     TupleSS2[Array[Clob], Long]    
     def allColumns = exeCodeScr_Scenario  ~ id_scenarioScr_Scenario     
     def allColumns1 = Seq(exeCodeScr_Scenario  , id_scenarioScr_Scenario )    
    
/////////////////////////////////////////////// Fetch Product ///////////////////////////////////////////////    
     def selectPList(join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationEx[List[Scr_ScenarioExeCodeDSData]] = 
            ...
            case Success(list) => 
                ValidationEx(Success(list map {
                    case TupleSS2(exeCodeScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) => 
                        Scr_ScenarioExeCodeDSData(exeCodeScr_Scenario = exeCodeScr_Scenario , id_scenarioScr_Scenario = id_scenarioScr_Scenario )
                }))
            case Failure(x) => 
     ...
     def selectPIterator[FT <: Product with FieldProduct](columns: FT = allColumns, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationExIterator[Iterator[Scr_ScenarioExeCodeDSData]] = 
    ...
    case TupleSS2(exeCodeScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) => 
     ...
     def selectPOne(join: JoinParam = null, where: WhereParam = null): ValidationEx[Scr_ScenarioExeCodeDSData] = 
                selectOneRoot(columns = allColumns, from = FromBo(Scr_Scenario), join = join, where = where, discriminator = null).result match {
            case Success(TupleSS2(exeCodeScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long)) => 
                ValidationEx(Success(Scr_ScenarioExeCodeDSData(exeCodeScr_Scenario = exeCodeScr_Scenario , id_scenarioScr_Scenario = id_scenarioScr_Scenario )))
            case Failure(x) => 
                ValidationEx(Failure(x))
            case x => 
                throw new RuntimeException(s"Bad branch. (${x})")
...
///////////////////////////////////////////////// insert /////////////////////////////////////////////////    
     ...
     def insertP(values: Scr_ScenarioExeCode*): ValidationEx[List[Int]] = Scr_Scenario.insertP(values: _*)    
     ...
     def insertPWithoutCommit(connection: Connection, values: Scr_ScenarioExeCode*): List[Int] = Scr_Scenario.insertPWithoutCommit(connection = connection, values: _*)    
//////////////////////////////////////////////// End insert ////////////////////////////////////////////////    
...
///////////////////////////////////////////////// update /////////////////////////////////////////////////    
     ...
     def updateP(values: Scr_ScenarioExeCode, where: WhereParam): ValidationEx[List[Int]] = Scr_Scenario.updateP(value = values, where = where)    
     ...
     def updatePWithoutCommit(connection: Connection, values: Scr_ScenarioExeCode, where: WhereParam): List[Int] = Scr_Scenario.updatePWithoutCommit(connection = connection, value = values, where = where)    
//////////////////////////////////////////////// End update ////////////////////////////////////////////////    
