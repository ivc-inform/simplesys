...
case class Scr_ScenarioClobConfigErrorDSData(clobConfigErrorScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) {

}


 
object Scr_ScenarioClobConfigErrorDS {
     def apply(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioClobConfigErrorDS(alias = SQLAlias(strEmpty))    
     def apply(alias: SQLAlias)(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioClobConfigErrorDS    
...
class Scr_ScenarioClobConfigErrorDS(override val alias: SQLAlias)(implicit val dataSource: BoneCPDataSource) extends DataSet[Scr_ScenarioClobConfigErrorDS]  {
     def this()(implicit dataSource: BoneCPDataSource) = this(SQLAlias(strEmpty))(dataSource)    
    
    val quoted = true    
    
     def init[FT <: Product with FieldProduct](columns: FT = null, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null): Scr_ScenarioClobConfigErrorDS = {
        _columns = columns
        _join Join join
        _where Where where
...
///////////////////////////////////////// Class: Scr_ScenarioBo, group: scenarios /////////////////////////////////////////    
    ...
    val Scr_Scenario = new Scr_ScenarioBoClobConfigError(alias = alias + "B0".als)    
...
//////////////////////////////////////////////// End Fetch ////////////////////////////////////////////////    
    ...
    val clobConfigErrorScr_Scenario = Scr_Scenario.clobConfigError    
...
//////////////////////////////////////// End Class: Scr_ScenarioBo, group: scenarios ////////////////////////////////////////    
    ...
    // For select tuple: (clobConfigErrorScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long)    
    
    type ColumnTypes =     TupleSS2[Array[Clob], Long]    
     def allColumns = clobConfigErrorScr_Scenario  ~ id_scenarioScr_Scenario     
     def allColumns1 = Seq(clobConfigErrorScr_Scenario  , id_scenarioScr_Scenario )    
    
/////////////////////////////////////////////// Fetch Product ///////////////////////////////////////////////    
     def selectPList(join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationEx[List[Scr_ScenarioClobConfigErrorDSData]] = 
            ...
            case Success(list) => 
                ValidationEx(Success(list map {
                    case TupleSS2(clobConfigErrorScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) => 
                        Scr_ScenarioClobConfigErrorDSData(clobConfigErrorScr_Scenario = clobConfigErrorScr_Scenario , id_scenarioScr_Scenario = id_scenarioScr_Scenario )
                }))
            case Failure(x) => 
     ...
     def selectPIterator[FT <: Product with FieldProduct](columns: FT = allColumns, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationExIterator[Iterator[Scr_ScenarioClobConfigErrorDSData]] = 
    ...
    case TupleSS2(clobConfigErrorScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long) => 
     ...
     def selectPOne(join: JoinParam = null, where: WhereParam = null): ValidationEx[Scr_ScenarioClobConfigErrorDSData] = 
                selectOneRoot(columns = allColumns, from = FromBo(Scr_Scenario), join = join, where = where, discriminator = null).result match {
            case Success(TupleSS2(clobConfigErrorScr_Scenario: Array[Clob], id_scenarioScr_Scenario: Long)) => 
                ValidationEx(Success(Scr_ScenarioClobConfigErrorDSData(clobConfigErrorScr_Scenario = clobConfigErrorScr_Scenario , id_scenarioScr_Scenario = id_scenarioScr_Scenario )))
            case Failure(x) => 
                ValidationEx(Failure(x))
            case x => 
                throw new RuntimeException(s"Bad branch. (${x})")
...
///////////////////////////////////////////////// insert /////////////////////////////////////////////////    
     ...
     def insertP(values: Scr_ScenarioClobConfigError*): ValidationEx[List[Int]] = Scr_Scenario.insertP(values: _*)    
     ...
     def insertPWithoutCommit(connection: Connection, values: Scr_ScenarioClobConfigError*): List[Int] = Scr_Scenario.insertPWithoutCommit(connection = connection, values: _*)    
//////////////////////////////////////////////// End insert ////////////////////////////////////////////////    
...
///////////////////////////////////////////////// update /////////////////////////////////////////////////    
     ...
     def updateP(values: Scr_ScenarioClobConfigError, where: WhereParam): ValidationEx[List[Int]] = Scr_Scenario.updateP(value = values, where = where)    
     ...
     def updatePWithoutCommit(connection: Connection, values: Scr_ScenarioClobConfigError, where: WhereParam): List[Int] = Scr_Scenario.updatePWithoutCommit(connection = connection, value = values, where = where)    
//////////////////////////////////////////////// End update ////////////////////////////////////////////////    
