...
object Scr_ScenarioBoClobConfigError {
     def apply(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioBoClobConfigError(alias = SQLAlias(strEmpty))    
     def apply(alias: SQLAlias)(implicit dataSource: BoneCPDataSource) = new Scr_ScenarioBoClobConfigError(alias = alias)    
...
class Scr_ScenarioBoClobConfigError(val alias: SQLAlias)(implicit val dataSource: BoneCPDataSource) extends ClassBO[Scr_ScenarioBoClobConfigError]  {
///////////////////////////////////////// Class: Scr_Scenario, group: scenarios /////////////////////////////////////////    
    
     def this()(implicit dataSource: BoneCPDataSource) = this(SQLAlias(strEmpty))(dataSource)    
    
     def init[FT <: Product with FieldProduct](columns: FT = null, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null): Scr_ScenarioBoClobConfigError = {
        _columns = columns
        _join Join join
        _where Where where
...
///////////////////////////////////////////////// Tables /////////////////////////////////////////////////    
    ...
    val Scr_ScenarioTbl = new Scr_ScenarioTblClobConfigError(alias = alias + "T0".als)    
    override val fromTable = Scr_ScenarioTbl    
//////////////////////////////////////////////// End Tables ////////////////////////////////////////////////    
////////////////////////////////////////////// Columns for select //////////////////////////////////////////////    
    val clobConfigError = ClobOptionColumn(name = "CLBCLOBCONFIGERROR", nameInBo = "clobConfigError", caption = "Config Error", tableColumn = Scr_ScenarioTbl.clobConfigErrorOption)    
    ...
    // For select tuple: (clobConfigError: Array[Clob], id_scenario: Long)    
    
    type ColumnTypes =     TupleSS2[Array[Clob], Long]    
    val allColumns = clobConfigError ~ id_scenario    
    val allColumns1 = Seq(clobConfigError , id_scenario)    
    val constraints = 
...
////////////////////////////////////////////// Table: Scr_Scenario //////////////////////////////////////////////    
    val clobConfigErrorScr_ScenarioTbl = Scr_ScenarioTbl.clobConfigErrorOption    
...
/////////////////////////////////////////////// Fetch Product ///////////////////////////////////////////////    
     ...
     def selectPIterator[FT <: Product with FieldProduct](columns: FT = allColumns, join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationExIterator[Iterator[Scr_ScenarioClobConfigError]] = 
    ...
    case TupleSS2(clobConfigError: Array[Clob], id_scenario: Long) => 
        Scr_ScenarioClobConfigError(clobConfigError = clobConfigError, id_scenario = id_scenario)
}    
    
     def selectPList(join: JoinParam = null, where: WhereParam = null, orderBy: OrderByParam = null, fetchSize: Int = dataSource.Config.FetchSize, dsRequest: DSRequest = null): ValidationEx[List[Scr_ScenarioClobConfigError]] = 
     ...
     def selectPOne(join: JoinParam = null, where: WhereParam = null): ValidationEx[Scr_ScenarioClobConfigError] = 
                selectOneRoot(columns = allColumns, from = From(Scr_ScenarioTbl), join = join, where = where, discriminator = null).result match {
            case Success(TupleSS2(clobConfigError: Array[Clob], id_scenario: Long)) => 
                ValidationEx(Success(Scr_ScenarioClobConfigError(clobConfigError = clobConfigError, id_scenario = id_scenario)))
            case Failure(x) => 
                ValidationEx(Failure(x))
            case x => 
                throw new RuntimeException(s"Bad branch. (${x})")
...
///////////////////////////////////////////////// Insert /////////////////////////////////////////////////    
     ...
     def insert(values: TupleSS2[Array[Clob], Long]*): ValidationEx[List[Int]] = 
        transaction(dataSource)
            {
            connection =>
                Scr_ScenarioTbl.insertWithoutCommit(connection = connection, columns = clobConfigErrorScr_ScenarioTbl ~ id_scenarioScr_ScenarioTbl, 
                    values map
                        {
                        value =>
                            Insert(clobConfigErrorScr_ScenarioTbl, value _1) Insert(id_scenarioScr_ScenarioTbl, value _2)
                    })
        }    
    
     def insertP(values: Scr_ScenarioClobConfigError*): ValidationEx[List[Int]] = 
        transaction(dataSource)
            {
            connection =>
                Scr_ScenarioTbl.insertWithoutCommit(connection = connection, columns = clobConfigErrorScr_ScenarioTbl ~ id_scenarioScr_ScenarioTbl, 
                    values map
                        {
                        value =>
                            Insert(clobConfigErrorScr_ScenarioTbl, value.clobConfigError) Insert(id_scenarioScr_ScenarioTbl, value.id_scenario)
                    })
        }    
    
     def insertWithoutCommit(connection: Connection, values: TupleSS2[Array[Clob], Long]*): List[Int] = {
        Scr_ScenarioTbl.insertWithoutCommit(connection = connection, columns = clobConfigErrorScr_ScenarioTbl ~ id_scenarioScr_ScenarioTbl, 
            values map
                {
                value =>
     ...
     def insertPWithoutCommit(connection: Connection, values: Scr_ScenarioClobConfigError*): List[Int] = {
        Scr_ScenarioTbl.insertWithoutCommit(connection = connection, columns = clobConfigErrorScr_ScenarioTbl ~ id_scenarioScr_ScenarioTbl, 
            values map
                {
                value =>
...
///////////////////////////////////////////////// Update /////////////////////////////////////////////////    
     def update(value: TupleSS2[Array[Clob], Long], where: WhereParam): ValidationEx[List[Int]] = 
        transaction(dataSource)
            {
            connection =>
                updateWithoutCommit(connection = connection, setters = Set(clobConfigError, value _1) Set(id_scenario, value _2), where = where, table = SQLTable(Scr_ScenarioTbl.databaseTablename))
        }    
    
     def updateP(value: Scr_ScenarioClobConfigError, where: WhereParam): ValidationEx[List[Int]] = 
        transaction(dataSource)
            {
            connection =>
                updateWithoutCommit(connection = connection, setters = Set(clobConfigError, value.clobConfigError) Set(id_scenario, value.id_scenario), where = where, table = SQLTable(Scr_ScenarioTbl.databaseTablename))
        }    
    
     def updateWithoutCommit(connection: Connection, value: TupleSS2[Array[Clob], Long], where: WhereParam): List[Int] = {
        updateWithoutCommit(connection = connection, setters = Set(clobConfigError, value _1) Set(id_scenario, value _2), where = where, table = SQLTable(Scr_ScenarioTbl.databaseTablename))
    }    
    
     def updatePWithoutCommit(connection: Connection, value: Scr_ScenarioClobConfigError, where: WhereParam): List[Int] = {
        updateWithoutCommit(connection = connection, setters = Set(clobConfigError, value.clobConfigError) Set(id_scenario, value.id_scenario), where = where, table = SQLTable(Scr_ScenarioTbl.databaseTablename))
    }    
//////////////////////////////////////////////// End Update ////////////////////////////////////////////////    
