...
import scenarios.ScenarioTrace_Debug
import com.simplesys.jdbc.control.clob._
import com.simplesys.common.array._
import com.simplesys.tuple._

 
object ScenarioTrace_DebugTbl {
     def apply(implicit dataSource: BoneCPDataSource) = new ScenarioTrace_DebugTbl(alias = SQLAlias(strEmpty))    
     def apply(alias: SQLAlias)(implicit dataSource: BoneCPDataSource) = new ScenarioTrace_DebugTbl(alias = alias)    
    
    val objectName = "ScenarioTrace_Debug"    
    val groupName = "scenarios"
}
 
class ScenarioTrace_DebugTbl(val alias: SQLAlias)(implicit val dataSource: BoneCPDataSource) extends Table[ScenarioTrace_DebugTbl]  {
    
    val quoted = true    
    
     def databaseTablename = "RTM_SCENARIOTRACE_DEBUG"    
...
//////////////////////////////////////////////// P Methods ////////////////////////////////////////////////    
     ...
     def insertP(values: ScenarioTrace_Debug*): ValidationEx[List[Int]] = insertRoot(allColumns, 
    values map
        {
        value =>
     ...
     def batch4PInsert(preparedStatement: PreparedStatement, values: ScenarioTrace_Debug*): Unit = batch4Insert(preparedStatement, 
    values map
        {
        value =>
            Insert(actionmessageOption, value.actionmessage) Insert(actionobjectOption, value.actionobject) Insert(actiontypeOption, value.actiontype) Insert(address, value.address) Insert(bonusbaseOption, value.bonusbase) Insert(bonusmessageOption, value.bonusmessage) Insert(event, value.event) Insert(id, value.id) Insert(idactionmessageOption, value.idactionmessage) Insert(idbonusmessageOption, value.idbonusmessage) Insert(idmarketingmessageOption, value.idmarketingmessage) Insert(marketingmessageOption, value.marketingmessage) Insert(parentstageOption, value.parentstage) Insert(scenario, value.scenario) Insert(stage, value.stage) Insert(timestamp, value.timestamp) 
     ...
     def insertPWithoutCommit(connection: Connection, values: ScenarioTrace_Debug*): List[Int] = insertWithoutCommit(connection, allColumns, 
    values map
        {
        value =>
            Insert(actionmessageOption, value.actionmessage) Insert(actionobjectOption, value.actionobject) Insert(actiontypeOption, value.actiontype) Insert(address, value.address) Insert(bonusbaseOption, value.bonusbase) Insert(bonusmessageOption, value.bonusmessage) Insert(event, value.event) Insert(id, value.id) Insert(idactionmessageOption, value.idactionmessage) Insert(idbonusmessageOption, value.idbonusmessage) Insert(idmarketingmessageOption, value.idmarketingmessage) Insert(marketingmessageOption, value.marketingmessage) Insert(parentstageOption, value.parentstage) Insert(scenario, value.scenario) Insert(stage, value.stage) Insert(timestamp, value.timestamp) 
