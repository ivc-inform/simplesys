...
case class DSRequest(data: Json, startRow: Option[Int] = None, endRow: Option[Int] = None, textMatchStyle: Option[String] = Some("exact"), sortBy: Vector[Json] = Vector.empty, transaction: Option[Transaction] = None, oldValues: Option[Json] = None) {
