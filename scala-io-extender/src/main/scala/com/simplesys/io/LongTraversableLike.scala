...
/**
 * The control signals for the limitFold method in [[com.simplesys.io.LongTraversable]].
 *
...
trait LongTraversableLike[+A, +Repr <: LongTraversableLike[A, Repr]] extends TraversableLike[A, Repr] {
   ...
   *
   * Unlike a normal fold, the function passed to limitFold returns a [[com.simplesys.io.FoldResult]] which both provides the
   ...
   *           The return value of the op is Either [[com.simplesys.io.Continue]] or [[com.simplesys.io.End]] indicating if the
   *           process should continue to next element or terminate, returning the value contained in the result object
   * @return the last value contained in the [[com.simplesys.io.FoldResult]] which was returned by op
   */
