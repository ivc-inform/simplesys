...
/**
 * Factory for [[com.simplesys.io.CloseAction]].  Also contains the [[com.simplesys.io.CloseAction.Noop]] CloseAction
 */
object CloseAction {
  /**
   * Create a [[com.simplesys.io.CloseAction]] from a function.  The function is the action that is performed
   * on close.
   */
  ...
  /**
   * The unit/nothing [[com.simplesys.io.CloseAction]]
   */
...
/**
 * A strategy object representing an action to take upon closing a [[com.simplesys.io.Resource]].
 * CloseActions can be composed using the +: and :+ method and can be added to a [[com.simplesys.io.Resource]]
 * when it is created or added to an existing [[com.simplesys.io.Resource]] object.
 *
 ...
 * the [[com.simplesys.io.CloseAction]].apply factory method.  It takes a function and contructs
