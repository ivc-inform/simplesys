...
import com.simplesys.io.CloseAction.Noop
 ...
 * is different for each implementation.  In the case of a [[com.simplesys.io.Resource]].fromFile
 * reach write will write to the beginning of the file rather than appending to the file.
 *
 * @author Jesse Eichar
 * @since 1.0
 *
 * @see [[com.simplesys.io.ReadChars]]
 * @see [[com.simplesys.io.Input]]
 * @see [[com.simplesys.io.WriteChars]]
 */
trait Output {
   ...
   *
   * @param data
   *          The data to write to underlying object.  Any data that has a resolvable [[com.simplesys.io.OutputConverter]] can
   *          be written.  See the [[com.simplesys.io.OutputConverter]] object for the defined [[com.simplesys.io.OutputConverter]]
  ...
  /**
   * Since the [[com.simplesys.io.OutputConverter]] object defined for writing Ints encodes Ints using 4 bytes this method
