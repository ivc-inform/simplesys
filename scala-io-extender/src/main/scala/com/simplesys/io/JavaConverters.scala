...
object JavaConverters {
  ...
  /**
   * Used by the [[com.simplesys.io.Input]] object for converting an arbitrary object to an Input Object
   *
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsInputConverter]].  They will be implicitly resolved allowing
   ...
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsOutputConverter]]
   */
  implicit def asOutputConverter[B](src:B)(implicit converter:AsOutputConverter[B]) =
    new AsOutput(converter.toOutput(src))

  /**
   * Used by the [[com.simplesys.io.Output]] object for converting an arbitrary object to an Output Object
   *
   * Note: this is a classic use of the type class pattern
   */
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsOutputConverter]].  They will be implicitly resolved allowing
   ...
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsReadCharsConverterFromBinary]]
   */
  ...
  /**
   * Used by the [[com.simplesys.io.ReadChars]] object for converting an arbitrary object to an ReadChars Object
   *
   * Note: this is a classic use of the type class pattern
   */
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsReadCharsConverterFromBinary]].  They will be implicitly resolved allowing
   ...
   * Wrap an arbitrary object as and AsReadChars object allowing the object to be converted to an ReadChars object.
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsReadCharsConverter]]
   */
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsReadCharsConverter]].  They will be implicitly resolved allowing
   ...
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsSeekableConverter]]
   */
  ...
  /**
   * Used by the [[com.simplesys.io.Seekable]] object for converting an arbitrary object to an Seekable Object
   *
   * Note: this is a classic use of the type class pattern
   */
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsSeekableConverter]].  They will be implicitly resolved allowing
   ...
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsWriteCharsConverter]]
   */
  ...
  /**
   * Used by the [[com.simplesys.io.WriteChars]] object for converting an arbitrary object to an WriteChars Object
   *
   * Note: this is a classic use of the type class pattern
   */
  ...
  /**
   * contains several implementations of [[com.simplesys.io.AsWriteCharsConverter]].  They will be implicitly resolved allowing
   ...
   *
   * The possible types of src are the subclasses of [[com.simplesys.io.AsInputConverter]]
   */
