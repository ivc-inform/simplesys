 ...
 *
 * The usage pattern of SeekableProcessor is the same as for [[com.simplesys.io.processing.OutputProcessor]] so
 ...
 *
 * @see com.simplesys.io.processing.OutputProcessor
 * @see com.simplesys.io.processing.OpenSeekable
 */
 ...
 *
 * This is an extension of [[com.simplesys.io.processing.OpenOutput]] and that class should be viewed for
 * details on how to use this class.  In fact an even better resource is [[com.simplesys.io.processing.OutputProcessor]]
 * since it has good examples.
 *
 * @see com.simplesys.io.processing.OpenOutput
 * @see com.simplesys.io.processing.OutputProcessor
 *
 * @define overwriteParam @param overwrite The strategy that dictates how many characters/bytes/units are overwritten
 * @define outputConverter [[com.simplesys.io.OutputConverter]]
 ...
 * @define intAsByteExplanation Since the [[com.simplesys.io.OutputConverter]] object defined for writing Ints encodes Ints using 4 bytes this method
