...
import com.simplesys.io.ResourceAdapting.{ChannelInputStreamAdapter, ChannelOutputStreamAdapter, ChannelReaderAdapter, ChannelWriterAdapter}

/**
 * A for accessing and using ByteChannels.  Class can be created using the [[com.simplesys.io.Resource]] object.
 */
