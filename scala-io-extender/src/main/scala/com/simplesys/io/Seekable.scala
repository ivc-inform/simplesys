 ...
 *
 * In addition to the methods contributed by [[com.simplesys.io.Input]] and [[com.simplesys.io.Output]] patch, insert
 * and append are provided as more random access style operations.
 *
 * Note: The methods in [[com.simplesys.io.Output]] are always fully destructive.  IE write
...
trait Seekable extends Input with Output {
 ...
 /**
   ...
   *          be converted to the encoding of [[com.simplesys.io.Codec]]
   */
