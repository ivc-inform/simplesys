...
object ImplicitConversions {
  /**
   * Method to implicitly convert a string to a [[com.simplesys.file.Path]]
   * object
   */
  implicit def string2path(s: String)(implicit fileSystem: FileSystem = FileSystem.default): Path = fileSystem.fromString(s)
  /**
   * Method to implicitly convert a [[java.io.File]] to a [[com.simplesys.file.defaultfs.DefaultPath]]
   * object
   */
  implicit def jfile2path(jfile: File): DefaultPath = FileSystem.default.fromString(jfile.getPath)
  /**
   * Implicitly convert a [[com.simplesys.file.defaultfs.DefaultPath]] to a [[java.io.File]]
   */
