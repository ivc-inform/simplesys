...
import com.simplesys.io.ResourceContext
...
object FileSystem {
   ...
   */
  val default: DefaultFileSystem = new com.simplesys.file.defaultfs.DefaultFileSystem()
...
abstract class FileSystem {
   ...
   */
  private[simplesys] lazy val cachedRoots: Set[PathType] = roots
  /**
   ...
   * This handler is used to construct URLs for the Paths as well as by com.simplesys.file.PathURLStreamHandlerFactory
